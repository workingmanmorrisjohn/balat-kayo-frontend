...
const PlayerIconGameplay = ({ player }: PlayerIconProps) => {
    return (<>
        <div className="flex flex-col items-centerbg-white gap-2 indicator bg-white p-2 rounded-lg shadow-sm">
            {
                player.currently_discussing ? 
                    (<span className="indicator-item badge badge-xs badge-success text-white">my turn!</span>)
                    : player.turn_ended ?
...
export default PlayerIconGameplay;